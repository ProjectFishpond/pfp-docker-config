...
c_nginx_source='https://nginx.org/download/nginx-1.11.10.tar.gz' #necessory or default [url]
c_nginx_source_asc='https://nginx.org/download/nginx-1.11.10.tar.gz.asc' # [url]
...
c_php_source='http://jp2.php.net/distributions/php-7.1.2.tar.xz' #necessory or default
c_php_source_asc='http://jp2.php.net/distributions/php-7.1.2.tar.xz.asc'
