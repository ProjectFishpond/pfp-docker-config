...
#Suffix definition
# _source                     a url the software download from
# _source_asc                 a url the corresponding pgp ASCII Armored file download from
# _source_asc_public_key      a url the corresponding pgp public key download from
...
c_nginx_user='nginx'
c_nginx_group='webService'
c_php_user='php-fpm'
c_php_group='webService'
...
c_nginx_source='https://nginx.org/download/nginx-1.12.1.tar.gz' #necessory or default [url]
c_nginx_source_asc='https://nginx.org/download/nginx-1.12.1.tar.gz.asc' # [url]
...
c_php_source='http://jp2.php.net/distributions/php-7.1.8.tar.xz' #necessory or default
c_php_source_asc='http://jp2.php.net/distributions/php-7.1.8.tar.xz.asc'
...
c_openssl_source='https://www.openssl.org/source/openssl-1.1.0f.tar.gz' #necessory or default
c_openssl_source_asc='https://www.openssl.org/source/openssl-1.1.0f.tar.gz.asc'
...
eval "https_proxy='$http_proxy' http_proxy='$http_proxy' yum install -y epel-release > $main_out_put 2>$err_out_put" && \
